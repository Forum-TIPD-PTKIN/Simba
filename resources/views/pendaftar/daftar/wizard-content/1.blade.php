...
<h5 class="mb-3">Step 1: Pendaftaran Beasiswa</h5>
<div class="row">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="text-success">Data PMB</h5>
                    </div>
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-12 col-md-5">
                    ...
                    @if (!$register)
                        ...
                        <form onsubmit="return confirmPendaftaran(event);" id="form-daftar"
                            ...
                            <div class="d-grid gap-2">
                                <button type="submit" class="btn btn-primary btn-lg fs-5"><i
                                        class="ti ti-checkbox"></i>
                            ...
                            $.ajax({
                                ...
                                error: function(response) {
                                    if (response.status !== 200) {
                                        ...
                                        errorText = errors ? Object.values(errors).map(
                                                err => err.join(', '))
                                            .join('\n') : null;
                                    }
                                    Swal.fire({
