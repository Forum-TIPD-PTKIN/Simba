...
@section('title', 'Seleksi Tes Potensi Akademik')
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page">Seleksi Tes Potensi Akademik</li>
                            </ul>
                        </div>
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h2 class="mb-0">Seleksi Tes Potensi Akademik</h2>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex flex-wrap justify-content-between align-items-center">
                            <h5 class="mb-3 mb-sm-0">Hasil Seleksi Tes Potensi Akademik</h5>
...
@push('script')
    <script>
        ...
        function reloadData() {
            $.ajax({
                url: "{{ route('pendaftar.seleksi-tpa') }}",
                data: {
