...
<nav class="pc-sidebar">
    <div class="navbar-wrapper">
        <div class="m-header">
            <a href="{{ route('surveyor.dashboard') }}" class="b-brand text-primary">
        ...
        <div class="navbar-content">
            ...
            <ul class="pc-navbar">
                ...
                <li class="pc-item">
                    <a href="{{ route('surveyor.dashboard') }}" class="pc-link">
                        <span class="pc-micon">
                            <svg class="pc-icon">
                ...
                <li class="pc-item">
                    <a href="{{ route('surveyor.persetujuan') }}" class="pc-link">
                        <span class="pc-micon">
