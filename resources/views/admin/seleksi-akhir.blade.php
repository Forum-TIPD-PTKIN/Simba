                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page">Seleksi Akhir</li>
                            </ul>
                        </div>
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h2 class="mb-0">Seleksi Akhir</h2>
                            </div>
                        </div>
                    </div>
                </div>
...
@push('script')
    ...
    <script>
        const dataTable = $("#tablePeserta").DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('admin.seleksi-akhir.data-peserta') }}",
                type: "POST",
                data: (data) => {
