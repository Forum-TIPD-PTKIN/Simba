...
class TemplatePelulusanPesertaSurvei implements
    FromCollection,
    ShouldAutoSize,
    WithMapping,
    WithHeadings,
    ...
    WithEvents
{
    ...
    {
        return 'template_pelulusan_peserta_survei';
    }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class    => function (AfterSheet $event) {
                ...
                $data_options_status = ['LOLOS', 'TIDAK LOLOS'];
                ...
                for ($i = 2; $i <= $totalRow; $i++) {
                    ...
                    // Conditional formatting: jika "TIDAK LOLOS", beri warna merah
                    ...
                    $conditionalGagal->addCondition('"TIDAK LOLOS"');
